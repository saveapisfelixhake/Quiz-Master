...
namespace Backend.Domains.Common.Persistence.Sql.Migrations
{
    ...
    [Migration("20250927132126_AddMissingQuizAttributes")]
    partial class AddMissingQuizAttributes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Domains.Quiz.Entity.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Backend.Domains.Quiz.Entity.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Backend.Domains.Quiz.Entity.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Backend.Domains.Quiz.Entity.Answer", b =>
                {
                    b.HasOne("Backend.Domains.Quiz.Entity.Question", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Backend.Domains.Quiz.Entity.Question", b =>
                {
                    b.HasOne("Backend.Domains.Quiz.Entity.Quiz", null)
                        .WithMany("Questions")
